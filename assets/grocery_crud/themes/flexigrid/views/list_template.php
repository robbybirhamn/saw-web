...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="tDiv">
		...
		<div class="tDiv2">
			...
			<button class="btn btn-primary btn-sm fbutton"><i class="fa fa-plus-circle"></i> <?php echo $this->l('list_add'); ?> <?php echo $subject?></button>
            </a>
		...
		<div class="tDiv3">
			<?php if(!$unset_import) { ?>
        	<a class="import-anchor" href="<?php echo $import_url; ?>">
				<button class="btn btn-default btn-sm fbutton"><i class="fa fa-table"></i> Import</button>
            </a>
			<?php } ?>

			<?php if(!$unset_exportdbf) { ?>
        	<a class="import-anchor" href="<?php echo $exportdbf_url; ?>">
				<button class="btn btn-success btn-sm fbutton"><i class="fa fa-table"></i> Export DBF</button>
            </a>
			<?php } ?>

			<?php if(!$unset_export) { ?>
        	<a class="export-anchor" href="<?php echo $export_url; ?>" download>
				<button class="btn btn-success btn-sm fbutton"><i class="fa fa-table"></i> <?php echo $this->l('list_export'); ?> <?php echo $subject?></button>
            </a>
			<?php } ?>
			<?php if(!$unset_print) { ?>
        	<a class="print-anchor" data-url="<?php echo $print_url; ?>">
				<button class="btn btn-info btn-sm fbutton"><i class="fa fa-print"></i> <?php echo $this->l('list_print'); ?> <?php echo $subject?></button>
            </a>
			<?php }?>
		</div>
		<div class='clear'></div>
