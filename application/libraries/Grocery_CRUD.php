...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function showList($ajax = false, $state_info = null)
	{
		...
		$data->exportdbf_url		= $this->getExportDbfUrl();
		...
		$data->unset_exportdbf			= $this->unset_exportdbf;
...
class grocery_CRUD_States extends grocery_CRUD_Layout
{
	...
	protected function getImportUrl()
	{
		...
		return base_url("/import/".$uriSegments[2]);
	}

	protected function getExportDbfUrl()
	{
		$uriSegments = explode("/", parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH));

		return base_url("/export/".$uriSegments[2]);
	}
...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $unset_import			= false;
	protected $unset_exportdbf			= false;
	...
	public function unset_import()
	{
		$this->unset_import = true;

		return $this;
	}

	public function unset_exportdbf()
	{
		$this->unset_exportdbf = true;
