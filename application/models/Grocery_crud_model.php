...
class Grocery_crud_model  extends CI_Model  {
    ...
    {
    	$primary_key_field = $this->get_primary_key();
		push_log('Memperbarui data pada '.$this->table_name,serialize($primary_key_value));
    ...
    function db_insert($post_array)
    {
    	...
    	if($insert)
    	{
			push_log('Menambah data pada '.$this->table_name,serialize($post_array));
    ...
    function db_delete($primary_key_value)
    {
    	...
    	if( $this->db->affected_rows() != 1)
			...
			push_log('Menghapus data pada '.$this->table_name,serialize($primary_key_value));
    		return true;
    }
